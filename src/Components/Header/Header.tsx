...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 w-full z-30">
      ...
      {/* 🔹 Top Strap */}
      <div className="w-full h-8 bg-gradient-to-r from-[#F3F3F3] to-[#FF7F50] flex items-center justify-between px-4 md:px-16 text-black text-sm font-medium">
        ...
        <div className="flex items-center gap-6">
          ...
          <span className="flex items-center gap-1">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
              <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h1.5a2.25 2.25 0 002.25-2.25v-.637c0-.516-.351-.966-.852-1.091l-4.423-1.106a1.125 1.125 0 00-1.173.417l-.97 1.293a.75.75 0 01-.8.269 12.035 12.035 0 01-7.143-7.143.75.75 0 01.27-.8l1.292-.97c.364-.273.527-.739.417-1.173L6.228 3.102A1.125 1.125 0 005.137 2.25H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
            </svg>
      ...
      {/* 🔹 Main Header */}
      <div className={`${flexBetween} p-4 md:px-16 bg-[#4682B4] shadow-md transition-all duration-300`}>
