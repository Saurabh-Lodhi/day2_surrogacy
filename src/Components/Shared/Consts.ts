...
// export const links = ['Home', 'About', 'Services', 'FAQ', 'Contact'];
...
//     description:
//       'Comprehensive surrogacy services with carefully screened surrogates, legal support, and medical care throughout the pregnancy.',
//   },
//   {
//     icon: '❤️',
//     title: 'IVF Treatment',
//     description:
//       'Advanced IVF procedures using the latest technology and techniques to maximize success rates for intended parents.',
//   },
//   {
//     icon: '👥',
//     title: 'Egg Donation',
//     description:
//       'Access to a diverse database of healthy, pre-screened egg donors to help you build your family.',
//   },
// ];
...
//     answer:
//       'Yes, surrogacy is legal in Ukraine for married heterosexual couples. Ukraine has clear legislation supporting gestational surrogacy, making it one of the most popular destinations for international intended parents.',
//   },
//   {
//     question: 'What is the success rate of IVF in Ukraine?',
//     answer:
//       'Our clinic maintains success rates comparable to leading international fertility centers, typically ranging from 50-70% depending on various factors including age and health conditions of the intended parents.',
//   },
//   {
//     question: 'How long does the surrogacy process take?',
//     answer:
//       'The entire surrogacy journey typically takes 12-18 months from initial consultation to birth, including surrogate matching, medical procedures, pregnancy, and delivery.',
//   },
//   {
//     question: 'What are the costs involved?',
//     answer:
//       'Costs vary depending on the specific program and services required. We offer transparent pricing and detailed breakdowns during your initial consultation. Ukraine remains one of the most cost-effective destinations for fertility treatments.',
//   },
//   {
//     question: 'How are egg donors screened?',
//     answer:
//       'All egg donors undergo comprehensive medical, genetic, and psychological screening. We maintain strict selection criteria to ensure the health and quality of donated eggs.',
//   },
// ];

// export const FooterData = {
//   logo: '/vite.svg',
//   addresses: ['Kyiv, Ukraine', 'Medical District'],
//   phone: '+380 XX XXX XXXX',
//   email: 'info@ukrainefertility.com',
//   departments: ['Surrogacy', 'IVF Treatment', 'Egg Donation', 'Consultation'],
//   links: ['About Us', 'Services', 'FAQ', 'Contact', 'Privacy Policy'],
// };
